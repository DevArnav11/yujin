...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Yujin — Create. Inspire. Elevate." },
      { name: "description", content: "Cozy, considered apparel that ignites your style. Discover the Yujin Summer Arc drop." },
      { property: "og:title", content: "Yujin — Create. Inspire. Elevate." },
      { property: "og:description", content: "Cozy, considered apparel that ignites your style." },
